...
G [iM.LL] = + Bra2(j2,-1) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j3,j4,nu);
G [iM.LR] = + Bra2(j2,+1) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j3,j4,nu);
G [iM.RL] = + Bra2(j2,-1) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j3,j4,nu);
G [iM.RR] = + Bra2(j2,+1) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j3,j4,nu);
...
endrepeat;
id gamma(q) = - gamma(j1) - gamma(j2);
id gamma(k) = + gamma(j3) + gamma(j4);
