...
def loop_amplitude(number_of_loops, p):

    s, Ang, Sq, GlobFac_3, GlobFac_4 = helicities.helicities(3, p)
    A = form_factor.form_factor_loop(p)
    B = form_factor.form_factor_loop(p)
    ...
    # 3-point amplitudes
    MLRLL_3 = n_loop_factor * (B[1][number_of_loops] - s[1,2] / 2 * B[2][number_of_loops]) * Sq[1,2] * (Ang[3,1] * Sq[1,4] - Ang[3,2] * Sq[2,4]) * GlobFac_3 * (const.vev/2 * const.C1)
    MRLLL_3 = n_loop_factor * (B[1][number_of_loops] - s[1,2] / 2 * B[2][number_of_loops]) * Ang[1,2] * (Ang[3,1] * Sq[1,4] - Ang[3,2] * Sq[2,4]) * GlobFac_3 * (const.vev/2 * const.C2)
    MLLLL_3 = n_loop_factor * B[3][number_of_loops] * Ang[2,3] * Sq[4,1] * GlobFac_3 * (const.S3 + const.vev/2 * const.C3)
    MRRLL_3 = n_loop_factor * B[3][number_of_loops] * Ang[3,1] * Sq[2,4] * GlobFac_3 * (const.vev/2 * const.C4)

    # 4-point amplitudes
    MLRLL_4 = n_loop_factor * ( 2 * A[1][number_of_loops] * Sq[4,1] * Sq[2,4] * Ang[3,4] + A[2][number_of_loops] * (s[2,3] + s[2,4]) / 2 * Sq[1,2] * Ang[1,3] * Sq[1,4] + A[2][number_of_loops] * (- s[1,3] - s[1,4]) / 2 * Sq[1,2] * Ang[2,3] * Sq[2,4]) * GlobFac_4 * const.C1
    MRLLL_4 = n_loop_factor * ( 2 * A[1][number_of_loops] * Ang[1,3] * Ang[2,3] * Sq[3,4] + A[2][number_of_loops] * (s[2,3] + s[2,4]) / 2 * Ang[1,2] * Ang[1,3] * Sq[1,4] + A[2][number_of_loops] * (- s[1,3] - s[1,4]) / 2 * Ang[1,2] * Ang[1,3] * Sq[2,4]) * GlobFac_4 * const.C2
    MLLLL_4 = n_loop_factor * A[3][number_of_loops] * Ang[2,3] * Sq[4,1] * GlobFac_4 * const.C3
    MRRLL_4 = n_loop_factor * A[3][number_of_loops] * Ang[3,1] * Sq[2,4] * GlobFac_4 * const.C4
...
def loop_squared_amplitude(number_of_loops, p):

    spin_color_factor = const.Nc / (4 * const.Nc**2)

    # Total leading order, one-loop, and two-loop helicity amplitudes
    MLRLL0, MRLLL0, MLLLL0, MRRLL0 = loop_amplitude(0, p)
    MLRLL1, MRLLL1, MLLLL1, MRRLL1 = loop_amplitude(1, p)
    MLRLL2, MRLLL2, MLLLL2, MRRLL2 = loop_amplitude(2, p)
...
def single_real_amplitude(number_of_loops, p):

    s, Ang, Sq, GlobFac_3, GlobFac_4 = helicities.helicities(4, p)
    A = form_factor.form_factor_single_real(p)
    B = form_factor.form_factor_single_real(p)
    ...
    # 3-point amplitudes
    MLRLLL_3 = n_loop_factor * (2 * B[12][number_of_loops] * Sq[1,2]**2 * Ang[1,5] * Ang[2,5] * ( Ang[1,3] * Sq[1,4] - Ang[2,3] * Sq[2,4] ) 
+ B[13][number_of_loops] * s[1,5] * Sq[1,2] * Ang[2,5] * ( Ang[3,1] * Sq[1,4] * Sq[2,1] * Ang[1,5] - s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[14][number_of_loops] * s[1,5] * Sq[1,2] * Ang[2,5] * ( Ang[3,2] * Sq[2,4] * Sq[2,1] * Ang[1,5] - s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[15][number_of_loops] * s[1,5] * Sq[1,2] * Ang[2,5] * ( Ang[3,5] * Sq[5,4] * Sq[2,1] * Ang[1,5] - (s[5,3] + s[5,4]) * Sq[2,4] * Ang[3,5] ) 
+ B[16][number_of_loops] * Sq[1,2] * Ang[2,5] * ( Ang[1,3] * Sq[1,4] * Ang[1,5] * Sq[2,1] + s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[17][number_of_loops] * Sq[1,2] * Ang[2,5] * ( Ang[2,3] * Sq[2,4] * Ang[1,5] * Sq[2,1] + s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[18][number_of_loops] * Sq[1,2] * Ang[2,5] * ( Ang[3,5] * Sq[4,5] * Ang[1,5] * Sq[2,1] + (s[5,3] + s[5,4]) * Sq[2,4] * Ang[3,5] ) 
+ B[19][number_of_loops] * Sq[1,2] * Ang[3,5] * ( Ang[1,5] * Sq[1,4] + Ang[2,5] * Sq[2,4] ) 
+ B[20][number_of_loops] * Sq[1,2]**2 * Sq[1,4] * Ang[2,3] * Ang[1,5]**2 
+ B[21][number_of_loops] * Sq[1,2]**2 * Sq[2,4] * Ang[2,3] * Ang[2,5]**2 
+ B[22][number_of_loops] * Sq[1,2]**2 * Sq[1,4] * Ang[2,3] * Ang[2,5]**2 
+ B[23][number_of_loops] * Sq[1,2]**2 * Sq[2,4] * Ang[2,3] * Ang[2,5]**2 ) * GlobFac_3 * (const.vev/2 * const.C1)

    MLRRLL_3 = - n_loop_factor * (8 * B[8][number_of_loops] * Sq[1,2] * Ang[1,3] * Sq[1,5] * Sq[4,5] 
+ 8 * B[9][number_of_loops] * Sq[1,2] * Ang[2,3] * Sq[2,5] * Sq[4,5] 
+ 2 * B[10][number_of_loops] * Sq[1,5] * Sq[2,5] * (s[1,2] * Ang[3,5] * Sq[4,5] - (s[5,3] + s[5,4]) * Ang[1,3] * Sq[1,4] ) 
+ 2 * B[11][number_of_loops] * Sq[1,5] * Sq[2,5] * (s[1,2] * Ang[3,5] * Sq[4,5] - (s[5,3] + s[5,4]) * Ang[2,3] * Sq[2,4] ) 
+ 2 * B[12][number_of_loops] * s[1,2] * Sq[1,5] * Sq[2,5] * ( Ang[2,3] * Sq[2,4] - Ang[1,3] * Sq[1,4] ) 
+ ( s[1,5] * B[13][number_of_loops] + B[16][number_of_loops] ) * Sq[2,1] * Sq[2,5] * ( Ang[3,1] * Sq[1,4] * Ang[1,2] * Sq[1,5] + s[1,2] * Ang[2,3] * Sq[4,5] ) 
+ ( s[1,5] * B[14][number_of_loops] + B[17][number_of_loops] ) * Sq[2,1] * Sq[2,5] * Ang[2,3] * ( Ang[2,1] * Sq[2,4] * Sq[1,5] + s[1,2] * Sq[4,5] ) 
+ ( s[1,5] * B[15][number_of_loops] + B[18][number_of_loops] ) * Sq[2,1] * Sq[2,5] * Sq[4,5] * ( Ang[2,1] * Sq[1,5] * Ang[3,5] + (s[5,3] + s[5,4]) * Ang[2,3] ) 
+ B[19][number_of_loops] * Sq[2,1] * Ang[3,5] * ( Sq[1,5] * Sq[1,4] + Sq[2,5] * Sq[2,4] ) 
+ ( s[1,5] * B[20][number_of_loops] + s[2,5] * B[22][number_of_loops] ) * Sq[1,2]**2 * Sq[1,4] * Ang[2,3] 
+ ( s[2,5] * B[21][number_of_loops] + s[1,5] * B[23][number_of_loops] ) * Sq[1,2]**2 * Sq[2,4] * Ang[2,3] ) * GlobFac_3 * (const.vev/2 * const.C1)

    MRLLLL_3 = n_loop_factor * (4 * ( B[8][number_of_loops] + B[9][number_of_loops] ) * Ang[1,5] * Ang[2,5] * ( Ang[2,3] * Sq[2,4] + Ang[1,3] * Sq[1,4] ) 
+ 2 *B[10][number_of_loops] * Ang[1,5] * Ang[2,5] * ( (s[5,3] + s[5,4]) * Ang[3,1] * Sq[1,4] * s[1,2] * Ang[3,5] * Sq[5,4] ) 
+ 2 *B[11][number_of_loops] * Ang[1,5] * Ang[2,5] * ( (s[5,3] + s[5,4]) * Ang[3,2] * Sq[2,4] * s[1,2] * Ang[3,5] * Sq[5,4] ) 
+ 2 *B[12][number_of_loops] * s[1,2] * Ang[1,5] * Ang[2,5] * ( Ang[2,3] * Sq[2,4] - Ang[1,3] * Sq[1,4] ) 
+ B[13][number_of_loops] * s[1,5] * Ang[1,2] * Ang[2,5] * ( Ang[3,1] * Sq[1,4] * Sq[2,1] * Ang[1,5] - s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[14][number_of_loops] * s[1,5] * Ang[1,2] * Ang[2,5] * ( Ang[3,2] * Sq[2,4] * Sq[2,1] * Ang[1,5] - s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[15][number_of_loops] * s[1,5] * Ang[1,2] * Ang[2,5] * ( Ang[3,5] * Sq[5,4] * Sq[2,1] * Ang[1,5] - (s[5,3] + s[5,4]) * Sq[2,4] * Ang[3,5] ) 
+ B[16][number_of_loops] * Ang[1,2] * Ang[2,5] * ( Ang[1,3] * Sq[1,4] * Ang[1,5] * Sq[2,1] + s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[17][number_of_loops] * Ang[1,2] * Ang[2,5] * ( Ang[2,3] * Sq[2,4] * Ang[1,5] * Sq[2,1] + s[1,2] * Sq[2,4] * Ang[3,5] ) 
+ B[18][number_of_loops] * Ang[1,2] * Ang[2,5] * ( Ang[3,5] * Sq[4,5] * Ang[1,5] * Sq[2,1] + (s[5,3] + s[5,4]) * Sq[2,4] * Ang[3,5] ) 
+ B[19][number_of_loops] * Ang[1,2] * Ang[3,5] * ( Ang[1,5] * Sq[1,4] + Ang[2,5] * Sq[2,4] ) 
+ B[20][number_of_loops] * s[1,2] * Sq[1,4] * Ang[3,2] * Ang[1,5]**2 
+ B[21][number_of_loops] * s[1,2] * Sq[2,4] * Ang[3,2] * Ang[2,5]**2 
+ B[22][number_of_loops] * s[1,2] * Sq[1,4] * Ang[3,2] * Ang[2,5]**2 
+ B[23][number_of_loops] * s[1,2] * Sq[2,4] * Ang[3,2] * Ang[1,5]**2 ) * GlobFac_3 * (const.vev/2 * const.C2)

    MRLRLL_3 = - n_loop_factor * (2 * B[12][number_of_loops] * Ang[1,2]**2 * Sq[1,5] * Sq[2,5] * ( Ang[1,3] * Sq[1,4] - Ang[2,3] * Sq[2,4] ) 
+ ( s[1,5] * B[13][number_of_loops] + B[16][number_of_loops] ) * Ang[1,2] * Sq[2,5] * ( Ang[3,1] * Sq[1,4] * Ang[1,2] * Sq[1,5] + s[1,2] * Ang[2,3] * Sq[4,5] ) 
+ ( s[1,5] * B[14][number_of_loops] + B[17][number_of_loops] ) * Ang[1,2] * Sq[2,5] * Ang[2,3] * ( Ang[2,1] * Sq[2,4] * Sq[1,5] + s[1,2] * Sq[4,5] ) 
+ ( s[1,5] * B[15][number_of_loops] + B[18][number_of_loops] ) * Ang[1,2] * Sq[2,5] * Sq[4,5] * ( Ang[2,1] * Sq[1,5] * Ang[3,5] + (s[5,3] * s[5,4]) * Ang[2,3] ) 
+ B[19][number_of_loops] * Ang[1,2] * Ang[3,5] * ( Sq[1,5] * Sq[1,4] + Sq[2,5] * Sq[2,4] ) 
+ ( s[1,5] * B[20][number_of_loops] + s[2,5] * B[22][number_of_loops] ) * s[1,2] * Sq[1,4] * Ang[2,3] 
+ ( s[2,5] * B[21][number_of_loops] + s[1,5] * B[23][number_of_loops] ) * s[1,2] * Sq[2,4] * Ang[2,3] ) * GlobFac_3 * (const.vev/2 * const.C2)

    MLLLLL_3 = n_loop_factor * (( s[1,2] * B[1][number_of_loops] + s[1,2] * B[2][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * B[3][number_of_loops] + 2 * s[2,5] * B[7][number_of_loops] ) * Ang[5,2] * Ang[5,3] * Sq[4,1] 
+ B[4][number_of_loops] * Ang[3,1] * Sq[1,4] * Ang[2,5]**2 * Sq[1,2] 
+ B[5][number_of_loops] * Ang[3,2] * Sq[2,4] * Ang[2,5]**2 * Sq[1,2] 
+ B[6][number_of_loops] * Ang[3,5] * Sq[5,4] * Ang[2,5]**2 * Sq[1,2] 
+ 2 * B[7][number_of_loops] * Ang[2,5] * Ang[1,5] * Sq[2,1] * Ang[2,3] * Sq[4,1] ) * GlobFac_3 * (const.S3 + const.vev/2 * const.C3)

    MLLRLL_3 = n_loop_factor * (B[1][number_of_loops] * Ang[3,1] * Sq[1,4] * Sq[1,5]**2 * Ang[1,2] 
+ B[2][number_of_loops] * Ang[3,2] * Sq[2,4] * Sq[1,5]**2 * Ang[1,2] 
+ B[3][number_of_loops] * Ang[3,5] * Sq[5,4] * Sq[1,5]**2 * Ang[1,2] 
+ 2 * B[7][number_of_loops] * Sq[1,5] * Sq[2,5] * Ang[1,2] * Ang[2,3] * Sq[4,1] 
+ ( s[1,2] * B[4][number_of_loops] + s[1,2] * B[5][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * B[6][number_of_loops] - 2 * s[1,5] * B[7][number_of_loops] ) * Sq[1,5] * Ang[2,3] * Sq[4,5] ) * GlobFac_3 * (const.S3 + const.vev/2 * const.C3)

    MRRLLL_3 = n_loop_factor * (B[1][number_of_loops] * Ang[3,1] * Sq[1,4] * Ang[1,5]**2 * Sq[2,1] 
+ B[2][number_of_loops] * Ang[3,2] * Sq[2,4] * Ang[1,5]**2 * Sq[2,1] 
+ B[3][number_of_loops] * Ang[3,5] * Sq[5,4] * Ang[1,5]**2 * Sq[2,1] 
+ 2 * B[7][number_of_loops] * Ang[1,5] * Ang[2,5] * Sq[2,1] * Sq[2,4] * Ang[3,1] 
+ ( s[1,2] * B[4][number_of_loops] + s[1,2] * B[5][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * B[6][number_of_loops] - 2 * s[1,5] * B[7][number_of_loops] ) * Ang[5,1] * Sq[2,4] * Ang[3,5] ) * GlobFac_3 * (const.vev/2 * const.C4)

    MRRRLL_3 = n_loop_factor * (( s[1,2] * B[1][number_of_loops] + s[1,2] * B[2][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * B[3][number_of_loops] + 2 * s[2,5] * B[7][number_of_loops] ) * Sq[2,5] * Sq[5,4] * Ang[3,1] 
+ B[4][number_of_loops] * Ang[3,1] * Sq[1,4] * Sq[2,5]**2 * Ang[2,1] 
+ B[5][number_of_loops] * Ang[3,2] * Sq[2,4] * Sq[2,5]**2 * Ang[2,1] 
+ B[6][number_of_loops] * Ang[3,5] * Sq[5,4] * Sq[2,5]**2 * Ang[2,1] 
+ 2 * B[7][number_of_loops] * Sq[1,5] * Sq[2,5] * Ang[2,1] * Sq[2,4] * Ang[3,1] ) * GlobFac_3 * (const.vev/2 * const.C4)

    
    # 4-point amplitudes
    MLRLLL_4 = n_loop_factor * (4 * A[12][number_of_loops] * Sq[1,2] * Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[1,5] * Ang[2,5] 
+ ( s[1,5] * A[13][number_of_loops] - A[16][number_of_loops] ) * Sq[1,2] * Ang[2,5] * (Sq[1,2] * Ang[1,3] * Sq[3,4] * Ang[3,5] + Sq[1,4] * Sq[2,4] * Ang[5,1] * Ang[3,4])
+ ( s[1,5] * A[14][number_of_loops] - A[17][number_of_loops] ) * Sq[2,1] * Sq[2,4]**2 * Ang[2,5]**2 * Ang[3,4] 
+ ( s[1,5] * A[15][number_of_loops] - A[18][number_of_loops] ) * s[2,5] * Sq[2,1] * Ang[3,5]**2 * Sq[3,4] 
+ A[19][number_of_loops] * Sq[1,2] * Ang[3,5]**2 * Sq[3,4] 
+ A[20][number_of_loops] * Sq[1,2] * Sq[1,4]**2 * Ang[1,5]**2 * Ang[3,4] 
+ A[21][number_of_loops] * Sq[2,1] * Ang[1,5] * ( Sq[1,2] * Ang[3,2] * Ang[3,5] * Sq[3,4] + Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[2,5] ) 
+ A[22][number_of_loops] * Sq[2,1] * Sq[1,4] * Sq[2,4] * Ang[1,5] * Ang[2,5] * Ang[3,4] 
+ A[23][number_of_loops] * Sq[1,2] * Sq[2,4]**2 * Ang[2,5] * Ang[3,4]) * GlobFac_4 * const.C1

    MLRRLL_4 = n_loop_factor * (8 * A[8][number_of_loops] * Sq[2,3] * Sq[3,4] * Ang[3,5] * Sq[5,1] 
+ 4 * A[9][number_of_loops] * Sq[3,1] * Sq[2,5] * Sq[3,4] * Ang[3,5] 
+ 2 * A[10][number_of_loops] * Sq[1,5] * Sq[2,5] * ( (s[5,3] + s[5,4]) * Ang[1,3] * Sq[1,4] - (s[1,3] + s[1,4]) * Ang[3,5] * Sq[4,5] ) 
+ 2 * A[11][number_of_loops] * Sq[1,5] * Sq[2,5] * ( (s[5,3] + s[5,4]) * Ang[2,3] * Sq[2,4] - (s[2,3] + s[2,4]) * Ang[3,5] * Sq[4,5] ) 
+ 2 * A[12][number_of_loops] * Sq[1,2] * Sq[1,3] * Sq[2,3] * Sq[4,3] * Ang[1,5] * Ang[2,5] 
+ A[13][number_of_loops] * Ang[1,5]**2 * Ang[2,5] * Sq[1,2] * (Sq[1,3] * Sq[2,3] * Sq[1,5] * Sq[3,4] + Sq[1,4] * Sq[4,5] * Ang[3,4] * Sq[1,2] ) 
+ A[14][number_of_loops] * s[2,5] * Sq[1,2] * Sq[2,3]**2 * Sq[3,4] * Ang[1,5]**2 
+ A[15][number_of_loops] * Sq[1,2] * Ang[1,5]**2 * Ang[2,5]**2 * Sq[3,4] * Sq[4,5]**2 
+ A[16][number_of_loops] * Sq[1,4] * Sq[2,3] * Sq[1,5] * Sq[2,5] * ( Ang[3,1] * Sq[2,3] + Ang[1,4] * Sq[2,4] ) 
+ A[17][number_of_loops] * Sq[2,4] * Sq[2,3] * Sq[1,5] * Sq[2,5] * ( Ang[3,2] * Sq[2,3] + Ang[2,4] * Sq[2,4] ) 
+ A[18][number_of_loops] * Sq[5,4] * Sq[2,3] * Sq[1,5] * Sq[2,5] * ( Ang[3,5] * Sq[2,3] + Ang[5,4] * Sq[2,4] ) 
+ A[19][number_of_loops] * Sq[2,1] * Sq[3,4] * Ang[3,5]**2 
+ A[20][number_of_loops] * Sq[2,1] * Sq[1,4]**2 * Ang[1,5]**2 * Ang[3,4] 
+ A[21][number_of_loops] * Sq[2,1] * Ang[1,5] * ( Sq[1,2] * Ang[3,2] * Ang[3,5] * Sq[3,4] + Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[2,5] ) 
+ A[22][number_of_loops] * Sq[2,1] * Sq[1,4] * Sq[2,4] * Ang[1,5] * Ang[2,5] * Ang[3,4] 
+ A[23][number_of_loops] * Sq[2,1] * Sq[2,4]**2 * Ang[2,5] * Ang[3,4]) * GlobFac_4 * const.C1

    MRLLLL_4 = n_loop_factor * (8 * A[8][number_of_loops] * Ang[2,3] * Sq[3,4] * Ang[3,5] * Ang[1,5] 
+ 4 * A[9][number_of_loops] * Ang[1,3] * Ang[2,5] * Sq[3,4] * Ang[3,5] 
+ 2 * A[10][number_of_loops] * Ang[1,5] * Ang[2,5] * ( (s[1,3] + s[1,4]) * Ang[3,5] * Sq[4,5] * - (s[5,3] + s[5,4]) * Ang[1,3] * Sq[1,4] ) 
+ 2 * A[11][number_of_loops] * Ang[1,5] * Ang[2,5] * ( (s[2,3] + s[2,4]) * Ang[3,5] * Sq[4,5] - (s[5,3] + s[5,4]) * Ang[2,3] * Sq[2,4] ) 
+ 2 * A[12][number_of_loops] * Sq[1,2] * Ang[1,3] * Ang[2,3] * Sq[4,3] * Ang[1,5] * Ang[2,5] 
+ A[13][number_of_loops] * Ang[1,5]**2 * Ang[2,5] * Sq[1,2] * (Ang[3,1] * Ang[2,3] * Sq[1,5] * Sq[3,4] + Sq[1,4] * Sq[4,5] * Ang[4,3] * Ang[1,2] ) 
+ A[14][number_of_loops] * s[2,5] * Sq[1,2] * Ang[2,3]**2 * Sq[3,4] * Ang[1,5]**2 
+ A[15][number_of_loops] * Sq[1,2] * Ang[1,5]**2 * Ang[2,5]**2 * Ang[4,3] * Sq[4,5]**2 
+ A[16][number_of_loops] * Sq[1,4] * Ang[2,3] * Ang[5,1] * Ang[2,5] * ( Ang[3,1] * Sq[2,3] + Ang[1,4] * Sq[2,4] ) 
+ A[17][number_of_loops] * Sq[2,4] * Ang[2,3] * Ang[5,1] * Ang[2,5] * ( Ang[3,2] * Sq[2,3] + Ang[2,4] * Sq[2,4] ) 
+ A[18][number_of_loops] * Sq[5,4] * Ang[2,3] * Ang[5,1] * Ang[2,5] * ( Ang[3,5] * Sq[2,3] + Ang[5,4] * Sq[2,4] ) 
+ A[19][number_of_loops] * Ang[1,2] * Sq[3,4] * Ang[3,5]**2 
+ A[20][number_of_loops] * Ang[1,2] * Sq[1,4]**2 * Ang[1,5]**2 * Ang[3,4] 
+ A[21][number_of_loops] * Ang[1,2] * Ang[1,5] * ( Sq[1,2] * Ang[3,2] * Ang[3,5] * Sq[3,4] + Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[2,5] ) 
+ A[22][number_of_loops] * Ang[1,2] * Sq[1,4] * Sq[2,4] * Ang[1,5] * Ang[2,5] * Ang[3,4] 
+ A[23][number_of_loops] * Ang[1,2] * Sq[2,4]**2 * Ang[2,5] * Ang[3,4]) * GlobFac_4 * const.C2

    MRLRLL_4 = n_loop_factor * (4 * A[12][number_of_loops] * Ang[2,1] * Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[1,5] * Ang[2,5] 
+ ( s[1,5] * A[13][number_of_loops] - A[16][number_of_loops] ) * Ang[2,1] * Ang[2,5] * (Ang[2,1] * Ang[1,3] * Sq[3,4] * Ang[3,5] + Sq[1,4] * Sq[2,4] * Ang[5,1] * Sq[3,4]) 
+ ( s[1,5] * A[14][number_of_loops] - A[17][number_of_loops] ) * Ang[1,2] * Sq[2,4]**2 * Ang[2,5]**2 * Ang[3,4] 
+ ( s[1,5] * A[15][number_of_loops] - A[18][number_of_loops] ) * s[2,5] * Ang[1,2] * Ang[3,5]**2 * Sq[3,4] 
+ A[19][number_of_loops] * Ang[2,1] * Ang[3,5]**2 * Sq[3,4] 
+ A[20][number_of_loops] * Ang[2,1] * Sq[1,4]**2 * Ang[1,5]**2 * Ang[3,4] 
+ A[21][number_of_loops] * Ang[1,2] * Ang[1,5] * ( Sq[1,2] * Ang[3,2] * Ang[3,5] * Sq[3,4] + Sq[1,4] * Sq[2,4] * Ang[3,4] * Ang[2,5] ) 
+ A[22][number_of_loops] * Ang[1,2] * Sq[1,4] * Sq[2,4] * Ang[1,5] * Ang[2,5] * Ang[3,4] 
+ A[23][number_of_loops] * Ang[2,1] * Ang[2,4]**2 * Ang[2,5] * Ang[3,4]) * GlobFac_4 * const.C2

    MLLLLL_4 = n_loop_factor * (( s[1,2] * A[1][number_of_loops] + s[1,2] * A[2][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * A[3][number_of_loops] + 2 * s[2,5] * A[7][number_of_loops] ) * Ang[5,2] * Ang[5,3] * Sq[4,1] 
+ A[4][number_of_loops] * Ang[3,1] * Sq[1,4] * Ang[2,5]**2 * Sq[1,2] 
+ A[5][number_of_loops] * Ang[3,2] * Sq[2,4] * Ang[2,5]**2 * Sq[1,2] 
+ A[6][number_of_loops] * Ang[3,5] * Sq[5,4] * Ang[2,5]**2 * Sq[1,2] 
+ 2 * A[7][number_of_loops] * Ang[2,5] * Ang[1,5] * Sq[2,1] * Ang[2,3] * Sq[4,1]) * GlobFac_4 * const.C3

    MLLRLL_4 = n_loop_factor * (A[1][number_of_loops] * Ang[3,1] * Sq[1,4] * Sq[1,5]**2 * Ang[1,2] 
+ A[2][number_of_loops] * Ang[3,2] * Sq[2,4] * Sq[1,5]**2 * Ang[1,2] 
+ A[3][number_of_loops] * Ang[3,5] * Sq[5,4] * Sq[1,5]**2 * Ang[1,2] 
+ 2 * A[7][number_of_loops] * Sq[1,5] * Sq[2,5] * Ang[1,2] * Ang[2,3] * Sq[4,1] 
+ ( s[1,2] * A[4][number_of_loops] + s[1,2] * A[5][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * A[6][number_of_loops] - 2 * s[1,5] * A[7][number_of_loops] ) * Sq[1,5] * Ang[2,3] * Sq[4,5] ) * GlobFac_4 * const.C3

    MRRLLL_4 = n_loop_factor * (A[1][number_of_loops] * Ang[3,1] * Sq[1,4] * Ang[1,5]**2 * Sq[2,1] 
+ A[2][number_of_loops] * Ang[3,2] * Sq[2,4] * Ang[1,5]**2 * Sq[2,1] 
+ A[3][number_of_loops] * Ang[3,5] * Sq[5,4] * Ang[1,5]**2 * Sq[2,1] 
+ 2 * A[7][number_of_loops] * Ang[1,5] * Ang[2,5] * Sq[2,1] * Sq[2,4] * Ang[3,1] 
+ ( s[1,2] * A[4][number_of_loops] + s[1,2] * A[5][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * A[6][number_of_loops] - 2 * s[1,5] * A[7][number_of_loops] ) * Ang[5,1] * Sq[2,4] * Ang[3,5] ) * GlobFac_4 * const.C4

    MRRRLL_4 = n_loop_factor * (( s[1,2] * A[1][number_of_loops] + s[1,2] * A[2][number_of_loops] + (s[1,2] + s[1,5] + s[2,5]) * A[3][number_of_loops] + 2 * s[2,5] * A[7][number_of_loops] ) * Sq[2,5] * Sq[5,4] * Ang[3,1] 
+ A[4][number_of_loops] * Ang[3,1] * Sq[1,4] * Sq[2,5]**2 * Ang[2,1] 
+ A[5][number_of_loops] * Ang[3,2] * Sq[2,4] * Sq[2,5]**2 * Ang[2,1] 
+ A[6][number_of_loops] * Ang[3,5] * Sq[5,4] * Sq[2,5]**2 * Ang[2,1] 
+ 2 * A[7][number_of_loops] * Sq[1,5] * Sq[2,5] * Ang[2,1] * Sq[2,4] * Ang[3,1] ) * GlobFac_4 * const.C4
...
def single_real_squared_amplitude(number_of_loops, p):

    spin_color_factor = const.Cf * const.Nc/((2 * const.Nc)**2)

    # Total single-real tree-level and virtual-real helicity amplitudes
    MLRLLL0, MLRRLL0, MRLLLL0, MRLRLL0, MLLLLL0, MLLRLL0, MRRLLL0, MRRRLL0 = single_real_amplitude(0, p)
    MLRLLL1, MLRRLL1, MRLLLL1, MRLRLL1, MLLLLL1, MLLRLL1, MRRLLL1, MRRRLL1 = single_real_amplitude(1, p)
...
def double_real_amplitude(p):

    s, Ang, Sq, GlobFac_3, GlobFac_4 = helicities.helicities(5, p)
...
def double_real_squared_amplitude(p):

    spin_color_factor1 = 4 * const.Nc * const.Cf**2
    spin_color_factor2 = const.Nc * const.Cf

    # Total double-real helicity amplitudes
    MLRLLLL, MLRLRLL, MLRRLLL, MLRRRLL, MRLLLLL, MRLLRLL, MRLRLLL, MRLRRLL, MLLLLLL, MLLLRLL, MLLRLLL, MLLRRLL, MRRLLLL, MRRLRLL, MRRRLLL, MRRRRLL = double_real_amplitude(p)
