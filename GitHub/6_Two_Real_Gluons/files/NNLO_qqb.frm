...
f  LepCurr, WqqbVertex, Q2prop, Q3prop, gqqbarVertex, gqqbarLeftVertex, gqqbarRightVertex, gammaGluonL, gammaGluonR, BSMcoupl, gggVertexLL, gggVertexLR, gggVertexRL, gggVertexRR, FinalqqbVertexLL, FinalqqbVertexRR, gamma, Bra, Ket, Ket1, Bra2;        *** Non-commuting functions
...
I  mu, nu, rho, sigma, lambda;                          						                                                              											                                       									   *** Indices


*** EXPRESSION FROM FEYNMAN DIAGRAMS STANDARD MODEL
*G [iM.SM_LLLL] = - Bra2(j2,-1) * WqqbVertex(mu) * Q3prop(j1,j3,j4) * FinalqqbVertexLL(j3,j4,lambda) * Ket1(j1,-1) * Wprop(q,mu,nu) * WHVertex(nu,sigma) * Wprop(k,sigma,rho) * LepCurr(j5,j6,rho)
*                 + Bra2(j2,-1) * FinalqqbVertexLL(j3,j4,lambda) * Q3prop(j2,j3,j4) * WqqbVertex(mu) * Ket1(j1,-1) * Wprop(q,mu,nu) * WHVertex(nu,sigma) * Wprop(k,sigma,rho) * LepCurr(j5,j6,rho);      
              
*G [iM.SM_LLRR] = - Bra2(j2,-1) * WqqbVertex(mu) * Q3prop(j1,j3,j4) * FinalqqbVertexRR(j3,j4,lambda) * Ket1(j1,-1) * Wprop(q,mu,nu) * WHVertex(nu,sigma) * Wprop(k,sigma,rho) * LepCurr(j5,j6,rho)
*                 + Bra2(j2,-1) * FinalqqbVertexRR(j3,j4,lambda) * Q3prop(j2,j3,j4) * WqqbVertex(mu) * Ket1(j1,-1) * Wprop(q,mu,nu) * WHVertex(nu,sigma) * Wprop(k,sigma,rho) * LepCurr(j5,j6,rho);
                 
                 
                 
                 

*** EXPRESSION FROM FEYNMAN DIAGRAMS BEYOND STANDARD MODEL                 
G [iM.BSM_LLLL] = - Bra2(j2,-1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexLL(j3,j4,lambda) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,-1) * FinalqqbVertexLL(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu);
                  
G [iM.BSM_LRLL] = - Bra2(j2,+1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexLL(j3,j4,lambda) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,+1) * FinalqqbVertexLL(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
                  
G [iM.BSM_RLLL] = - Bra2(j2,-1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexLL(j3,j4,lambda) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,-1) * FinalqqbVertexLL(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
                  
G [iM.BSM_RRLL] = - Bra2(j2,+1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexLL(j3,j4,lambda) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,+1) * FinalqqbVertexLL(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
                  
                  
                  
G [iM.BSM_LLRR] = - Bra2(j2,-1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexRR(j3,j4,lambda) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,-1) * FinalqqbVertexRR(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu);
                  
G [iM.BSM_LRRR] = - Bra2(j2,+1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexRR(j3,j4,lambda) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,+1) * FinalqqbVertexRR(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,-1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
                  
G [iM.BSM_RLRR] = - Bra2(j2,-1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexRR(j3,j4,lambda) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,-1) * FinalqqbVertexRR(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
                  
G [iM.BSM_RRRR] = - Bra2(j2,+1) * BSMcoupl(mu,k) * Q3prop(j1,j3,j4) * FinalqqbVertexRR(j3,j4,lambda) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu)
                  + Bra2(j2,+1) * FinalqqbVertexRR(j3,j4,lambda) * Q3prop(j2,j3,j4) * BSMcoupl(mu,k) * Ket1(j1,+1) * Wprop(k,mu,nu) * LepCurr(j5,j6,nu); 
...
*** VERTEX WITH FINAL QUARK-ANTIQUARK LEFT/Right
id FinalqqbVertexLL(j3?,j4?,mu?) = i_ * gs^2 * [za^-1](j3,j4) * [zb^-1](j4,j3) * gamma(mu) * zab(j3,mu,j4);
id FinalqqbVertexRR(j3?,j4?,mu?) = i_ * gs^2 * [za^-1](j3,j4) * [zb^-1](j4,j3) * gamma(mu) * zab(j4,mu,j3);
