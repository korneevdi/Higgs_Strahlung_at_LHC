...
YLABEL1=r"$ {\mathrm{d}}\sigma^{\mathrm{SMEFT}}_{\mathrm{NNLO}}/{\mathrm{d}}p_{\mathrm{T},H}\;\mathrm{[fb/GeV]} $"
YLABEL2=r"ratio"
#>> xlimit
XMIN0=0
XMAX0=240
...
#>> load data
### SM
xx,val_fit,err_fit,bins=load_histo(NHi,'./WpH_Hundk_fid_fit_cuW_0.321_cdW_0.521_cHq3_-0.718_cHud_0.451_NNLO_xMuR_1.00_xMuF_1.00_ptH.histo')
xx,val_full,err_full,bins=load_histo(NHi,'./WpH_Hundk_fid_test2mSM_NNLO_xMuR_1.00_xMuF_1.00_ptH.histo')
