...
YLABEL1=r"$$\frac{1}{\sigma_{\mathrm{NNLO}}} \,\, \frac{\mathrm{d}\sigma_{\mathrm{NNLO}}}{\mathrm{d}m_{WH}} \;\; \mathrm{[GeV]}$$"
...
# SM
xx, val_SM_LO, err_SM_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_SM_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_SM_NLO, err_SM_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_SM_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_SM_NNLO, err_SM_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_SM_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))

# cuWsq
xx, val_cuWsq_LO, err0_cuWsq_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cuW_1.0_noSM_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cuWsq_NLO, err0_cuWsq_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cuW_1.0_noSM_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cuWsq_NNLO, err0_cuWsq_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cuW_1.0_noSM_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))

# cdWsq
xx, val_cdWsq_LO, err0_cdWsq_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cdW_1.0_noSM_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cdWsq_NLO, err0_cdWsq_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cdW_1.0_noSM_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cdWsq_NNLO, err0_cdWsq_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cdW_1.0_noSM_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))

# cHq3^2
xx, val_cHq3sq_LO, err0_cHq3sq_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3_1.0_noSM_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHq3sq_NLO, err0_cHq3sq_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3_1.0_noSM_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHq3sq_NNLO, err0_cHq3sq_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3_1.0_noSM_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))

# cHq3
xx, val_cHq3_LO, err0_cHq3_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3Intf_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHq3_NLO, err0_cHq3_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3Intf_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHq3_NNLO, err0_cHq3_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHq3Intf_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))

# cHud^2
xx, val_cHudsq_LO, err0_cHudsq_LO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHud_1.0_noSM_LO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHudsq_NLO, err0_cHudsq_NLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHud_1.0_noSM_NLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
xx, val_cHudsq_NNLO, err0_cHudsq_NNLO, bins = load_histo(NHi, os.path.join(data_dir, 'WpH_Hundk_fid_cHud_1.0_noSM_NNLO_xMuR_1.00_xMuF_1.00_mVH.histo'))
...
#>> xlabel
plt.xlabel(XLABEL0, fontsize=14)
